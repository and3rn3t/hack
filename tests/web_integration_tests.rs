...
mod web_tests {
    ...
    use hack_simulator::web::{WebGameEngine, WebGameState, WebChallenge};
    use serde_json;
    ...
    fn test_challenge_serialization() {
        ...
        let challenges: Vec<serde_json::Value> = serde_json::from_str(&challenges_json)
            .expect("Challenges JSON should be valid");
    ...
    fn test_error_handling() {
        ...
        let result: serde_json::Value = serde_json::from_str(&result_json)
            .expect("Result should still be valid JSON");
